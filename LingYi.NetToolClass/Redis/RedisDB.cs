...
namespace LingYi.NetToolClass.Redis
{
    public static class RedisDB
    {

        public static int _store_db = 0;
        public static string _redisIP;
            ...
            get
            {
                if (_redis == null)
                {
                    lock (_locker)
                    {
                        ...
                        {
                            var options = ConfigurationOptions.Parse(_redisIP);
                            options.Password = string.Empty;
                            options.DefaultVersion = new Version(4, 0, 2);
    ...
    public enum RedisFolderEnum
    {
        ...
        /// 根目录
        /// </summary>
        [Description("LingYi.Im")]
        Root,

        /// <summary>
        /// 测试目录1
        /// </summary>
        [Description("LingYi.Im.Test1")]
        Folder1,

        /// <summary>
        /// 测试目录2
        /// </summary>
        [Description("LingYi.Im.Test2")]
        Folder2,

        /// <summary>
        /// 测试目录3
        /// </summary>
        [Description("LingYi.Im.Test3")]
        Folder3,

        /// <summary>
        /// 测试目录4
        /// </summary>
        [Description("LingYi.Im.Test4")]
        Folder4,

        /// <summary>
        /// 测试目录5
        /// </summary>
        [Description("LingYi.Im.Test5")]
        Folder5,

        /// <summary>
        /// 测试目录6
        /// </summary>
        [Description("LingYi.Im.Test6")]
        Folder6,
