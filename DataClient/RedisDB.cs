...
namespace DataClient
{
    public static class RedisDB
    {
        ...
        private static int _store_db = 0;
            ...
            get
            {
                if (_redis == null)
                {
                    lock (_locker)
                    {
                        ...
                        {
                            var options = ConfigurationOptions.Parse("172.18.115.94:6379");
        ...
        //https://www.cnblogs.com/liqingwen/archive/2017/04/06/6672452.html
